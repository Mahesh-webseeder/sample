...
function EducationalInformation() {
  const data = [
    { id: 1, candidateId: '17156636854885S', degree: 'B-Tech', university: 'RGPV', cgpa: '8.5', comments: 'Example' },
    { id: 1, candidateId: '18157736854885S', degree: 'B-Tech', university: 'RGPV', cgpa: '8.5', comments: 'Example' },
